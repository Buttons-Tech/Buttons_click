...
const HeroHeader = () => {
  return (
    <>
        <div className='text-[10px] flex flex-col leading-[19px] -mt-5 p-[29px] bg-white '>
          <div className='gap-2 flex '>
            <span className='text-[24px] font-black text-[#000000] '>EMPOWERING</span> <span className='text-[24px] text-[#000000] '> YOUR</span>
          </div> <br />
            <div className='gap-2 flex'>
            <span className='text-[24px]'>CHILD’S </span><span className='text-[24px] font-bold'>DIVERSE </span>
            </div> <br />
